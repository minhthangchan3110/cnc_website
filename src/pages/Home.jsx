    ...
    <div>
        <div className="bg-[linear-gradient(135deg,#0066CC_0%,#0052a3_100%)] pt-16 pb-12">
            ...
            <section className='max-w-300 mx-auto px-2 text-white flex'>
                <div className='w-1/2'>
                    <h2 className='text-[40px] font-bold leading-[1.2] mb-4'>Xưởng Gia Công Tiện CNC<br/><span className="text-orange-500">Chính Xác & Uy Tín</span></h2>
                    <p className='text-[17px] opacity-95 mb-8'>Chuyên gia công các chi tiết cơ khí tiện CNC với độ chính xác cao, đáp ứng mọi yêu cầu kỹ thuật khắt khe. Cam kết chất lượng và giao hàng đúng hẹn.</p>
                    <div className='flex w-full mb-8'>
                        <div className='w-1/2 flex flex-col gap-3'>
                            <div className='flex items-center gap-2 text-normal'>
                                <div className='bg-green-500 rounded-full p-1'><FaCheck color='white' size={10} /></div>
                    ...
                    <div className='flex gap-8'>
                        <button className='bg-amber-600 px-8 py-3 transition-all duration-300 hover:-translate-y-0.5 hover:cursor-pointer rounded-lg'>Liên hệ báo giá</button>
                        <button className="px-8 py-3 border hover:bg-white hover:text-black hover:border-white hover:duration-300 hover:cursor-pointer rounded-lg">Xem dịch vụ</button>
                    </div>
                </div>
                <div className='w-1/2 flex justify-end'>
                    <div>
                        <img src={banner} className='w-120 h-[362.5px] rounded-xl' alt="" />
                    </div>
                </div>
            </section>
        </div>
        ...
        <div className=''>
            ...
            <section className='max-w-300 mx-auto px-2 text-white pb-8'>
                <div className='text-black text-center my-8'>
                    <h2 className='text-[40px] font-bold mb-2'>Dịch Vụ Của Chúng Tôi</h2>
                    <p className='text-gray-400'>Đa dạng giải pháp gia công cơ khí đáp ứng mọi nhu cầu của bạn</p>
                </div>
        ...
        <div className='bg-[#f8f9fa]'>
            <section className='max-w-300 mx-auto px-2 flex items-center p-12'>
                <div className='w-1/2 text-start'>
                    <h2 className='text-[40px] mb-2 font-bold'>Tại Sao Chọn Chúng Tôi?</h2>
                    <p className='text-gray-400'>Những lý do khách hàng tin tưởng và lựa chọn dịch vụ của chúng tôi</p></div>
                <div className='w-1/2 flex flex-col gap-4'>
                    <WhyBox title="Máy móc hiện đại" description="Trang bị máy CNC nhập khẩu, đảm bảo độ chính xác và năng suất cao"/>
                    <WhyBox title="Đội ngũ lành nghề" description="Thợ kỹ thuật có kinh nghiệm lâu năm, tay nghề cao"/>
                    <WhyBox title="Giá cả hợp lý" description="Báo giá minh bạch, cạnh tranh nhất thị trường"/>
                    <WhyBox title="Giao hàng đúng hẹn" description="Cam kết tiến độ, giao hàng đúng thời gian đã hứa"/>
                </div>
            </section>
        ...
        <div className=''>
            <section className='max-w-300 mx-auto px-2 py-12'>
                <div className='text-center'>
                    ...
                    <p className='text-gray-400'>4 bước đơn giản để có sản phẩm hoàn hảo</p>
                </div>
  ...
  <section className="max-w-300 mx-auto px-4 py-12 text-white">
    ...
    <div className="text-center mb-8">
      ...
      <p className="opacity-90">
        Hãy để lại thông tin, chúng tôi sẽ tư vấn và báo giá miễn phí cho bạn trong 24h
      </p>
    </div>
